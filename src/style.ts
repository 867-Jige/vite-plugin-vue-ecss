// import { attrsKeys } from "./htmlAttrsKey";
...
// createAttrMap();
// 创建属性映射
// function createAttrMap() {
//   attrsKeys.forEach((attrKey) => {
//     createAbbKey(attrKey);
//   });
//   console.log(baseAttrsMap, "==========");
// }
// // 创建缩写属性key

// function createAbbKey(attrKey) {
//   let attrWords = attrKey.split("-").filter((item) => item);
//   let leng = attrWords.length;
//   let repeatCount = 0;
//   let abbWord = "";
//   let wordIndex = 0;
//   do {
...
//       .map((word, index) => {
//         let newWord = word[0];
//         if (leng - repeatCount <= index) {
//           newWord = leng > 1 ? capitalizeFirstLetter(word) : word;
//         }
//         return newWord;
//       })
//       .join("");
//     repeatCount++;
//   } while (baseAttrsMap[abbWord] && baseAttrsMap[abbWord] !== attrKey);
//   baseAttrsMap[abbWord] = attrKey;
// }
// // 首字母大写
